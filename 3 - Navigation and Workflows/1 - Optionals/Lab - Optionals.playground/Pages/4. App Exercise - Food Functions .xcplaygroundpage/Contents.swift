...
func mealInfo(mealTime: String?) -> Meal? {
    if let mealObject = meals[mealTime!] {
        return mealObject
    }
    return nil
}
let breakfastInfo = mealInfo(mealTime: "Breakfast")
let DinnerInfo = mealInfo(mealTime: "Dinner")
if let breakfastInfo = breakfastInfo {
    print(breakfastInfo)
}
if let DinnerInfo = DinnerInfo {
    print(DinnerInfo)
}
mealInfo(mealTime: "Breakfast")
/*:
 ...
 */
//func mealLogCheck(meals: [String: Meal]) -> String? {
...
//}
//func mealLog() -> String? {
//    // Attempt to retrieve the value for the key "mealLog"
//    if let value = UserDefaults.standard.dictionary(forKey: "mealLog") {
//        return value
//    }
//    // Return a default value if the key doesn't exist
//    return "No meal log has been served."
//}
//
//
//
