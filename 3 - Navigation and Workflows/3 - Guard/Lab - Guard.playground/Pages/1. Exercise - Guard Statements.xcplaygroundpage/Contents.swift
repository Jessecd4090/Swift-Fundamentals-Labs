...
func createUser() -> User? {
    ...
    var currentUser = User(firstName: firstName, lastName: lastName, age: age)
    return currentUser
}
...
var returnValue = createUser()
if let returnValueName = returnValue?.firstName, let returnValueLName = returnValue?.lastName, let returnValueAge = returnValue?.age {
    print("\(returnValueName) \(returnValueLName) is \(returnValueAge) years old.")
}
