...
var run1: () = progressUpdate(steps: 200, goal: 1000)
var run2: () = progressUpdate(steps: 1000, goal: 2000)
...
var run4: () = pacing(currentDistance: 15, totalDistance: 20, currentTime: 30, goalTime: 40)
