 ...
 */
var walkingChallenges = ["Walk around the football field 4 times", "Walk to work."]
var runningChallenges = ["Run 4 days of the week", "Run 3 miles every two weeks."]
...
if toDoList.isEmpty {
    print("There's no current challenges, try start one today!")
}   else if (toDoList.count == 1) {
    print("The challenge you have choosen is \(challenges[0])")
} else {
