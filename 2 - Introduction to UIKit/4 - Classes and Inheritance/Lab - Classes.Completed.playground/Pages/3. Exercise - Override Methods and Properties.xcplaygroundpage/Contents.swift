...
class Spaceship {
    ...
    func wasHit() { //what am I doing wrong here
        health -= 5
        if health <= 0 {
...
defender.wasHit()
defender.wasHit()
print("The shield strength is \(defender.shieldStrength), and the health is \(defender.health)")
...
defender.wasHit()
print("\(defender.shieldStrength) shield and \(defender.health) health left.")
